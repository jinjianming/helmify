...
func (o output) Create(chartDir, chartName, ChartVersion string, crd bool, certManagerAsSubchart bool, certManagerVersion string, templates []helmify.Template, filenames []string) error {
	err := initChartDir(chartDir, chartName, ChartVersion, crd, certManagerAsSubchart, certManagerVersion)
	if err != nil {
		return err
	}
