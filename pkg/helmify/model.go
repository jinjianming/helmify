...
type Output interface {
	Create(chartName, chartDir string, chartVersion string, Crd bool, certManagerAsSubchart bool, certManagerVersion string, templates []Template, filenames []string) error
}
